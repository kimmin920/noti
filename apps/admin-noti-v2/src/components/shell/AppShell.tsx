...
import type { PageId, ScheduledStatus } from "@/lib/store/types";
...
function AuthenticatedShell({
  ...
  const pageContent = (
    <PageContent
      ...
      scheduledSendsData={data.scheduledSends}
      scheduledSendsLoading={loading.scheduledSends}
      scheduledSendsError={errors.scheduledSends}
  ...
  return (
    <>
      <Topbar
        activePage={activePage}
        serviceName={isSuperAdminOpsPage ? "내부 운영" : data.bootstrap?.currentUser.serviceName ?? "NOTI"}
      ...
      <div className="layout">
        <Sidebar
          ...
          scheduledTodayCount={data.scheduledSends?.summary.todayCount ?? 0}
          scheduledCountLoading={loading.scheduledSends && !data.scheduledSends}
        />
        <main className="main">
