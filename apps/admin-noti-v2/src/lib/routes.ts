...
export const APP_ROUTES: AppRouteDef[] = [
  ...
  { id: "events", path: "/events", title: "알림톡 자동화", desc: "이벤트 기반 알림톡 자동화와 템플릿 연결을 관리합니다" },
  { id: "publ-events", path: "/publ-events", title: "Publ 이벤트", desc: "Publ 이벤트 카탈로그와 알림톡 변수를 관리합니다" },
  ...
  { id: "scheduled", path: "/scheduled", title: "예약 현황", desc: "예정된 예약 발송을 확인합니다" },
  ...
  { id: "messaging-nav-compare", path: "/ux/messaging-navigation", title: "메시징 내비게이션 비교", desc: "현재 구조와 권장 구조를 나란히 검토합니다" },
