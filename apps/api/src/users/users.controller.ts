...
export class UsersController {
  ...
  listFields(@Req() req: SessionRequest) {
    this.assertTenantAdmin(req);
    return this.service.listFields(req.sessionUser!.tenantId);
  }
  ...
  create(@Req() req: SessionRequest, @Body() dto: CreateManagedUserDto) {
    this.assertTenantAdmin(req);
    return this.service.createManualUser(req.sessionUser!.tenantId, dto);
  }
  ...
  importUsers(@Req() req: SessionRequest, @Body() dto: ImportUsersDto) {
    this.assertTenantAdmin(req);
    return this.service.importUsers(req.sessionUser!.tenantId, dto);
  }
}
