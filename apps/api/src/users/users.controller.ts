...
export class UsersController {
  ...
  listFields(@Req() req: SessionRequest) {
    this.assertUserAccess(req);
    return this.service.listFields(req.sessionUser!.userId);
  }
  ...
  create(@Req() req: SessionRequest, @Body() dto: CreateManagedUserDto) {
    this.assertUserAccess(req);
    return this.service.createManualUser(req.sessionUser!.userId, dto);
  }
  ...
  importUsers(@Req() req: SessionRequest, @Body() dto: ImportUsersDto) {
    this.assertUserAccess(req);
    return this.service.importUsers(req.sessionUser!.userId, dto);
  }
}
